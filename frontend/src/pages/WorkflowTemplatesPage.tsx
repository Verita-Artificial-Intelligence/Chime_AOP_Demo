        ...
        {templateConfigs.map((template) => {
          ...
          return (
            <div
              ...
              className="bg-white rounded-lg p-6 shadow-sm border border-brand-border hover:border-brand-primary hover:shadow-lg transition-all duration-200 group cursor-pointer"
            >
              <div className="flex items-start gap-4">
                <div
                  className={`p-3 rounded-lg bg-brand-primaryLight group-hover:bg-brand-primary transition-colors`}
                >
                  <IconComponent
