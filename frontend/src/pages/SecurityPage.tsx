...
export const SecurityPage: React.FC = () => {
  ...
  const generateNewAPIKey = () => {
    const newKey = `sk_prod_${Math.random()
      .toString(36)
    ...
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Manage security settings and OAuth configurations
        </p>
      </div>
                ...
                <button
                  onClick={() =>
                    openModal(
                      ...
                      <div className="space-y-4">
                        <p className="text-gray-600">
                          Configure Google OAuth 2.0 integration for secure user
                          authentication.
                        </p>
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                              value="https://your-app.com/auth/google/callback"
                              readOnly
                            />
                          </div>
                        </div>
                  ...
                  className="px-4 py-2 bg-brand-primary text-white rounded-md hover:bg-brand-primaryDark font-semibold transition-colors"
                >
                  Configure
                </button>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Enterprise authentication via Azure
                    </p>
                  </div>
                </div>
                <button
                  onClick={() =>
                    openModal(
                      ...
                      <div className="space-y-4">
                        <p className="text-gray-600">
                          Configure Microsoft Azure AD integration for
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-200">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  defaultChecked
                />
                <span className="absolute inset-0 flex items-center rounded-full bg-gray-200 transition-all duration-200 ease-out peer-focus:ring-2 peer-focus:ring-brand-primary peer-focus:ring-offset-2">
                  <span className="h-5 w-5 rounded-full bg-white shadow-md transform transition-all duration-200 ease-out translate-x-0 peer-checked:translate-x-5"></span>
                </span>
                <div className="absolute inset-0 rounded-full bg-gray-200 peer-checked:bg-brand-primary transition-colors duration-200 ease-out"></div>
              </label>
            </div>
            <div className="flex items-center justify-between py-3 border-b border-gray-200">
              <div>
              ...
              onClick={() =>
                openModal(
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        },
                        {
                          role: "Standard",
                          users: 24,
                          permissions: "Create and manage workflows",
                        },
                        {
                          role: "Read-Only",
                          users: 15,
                          permissions: "View workflows and reports only",
                        },
                      ].map((item) => (
                        <div
                          key={item.role}
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                              ...
                              <button className="text-sm text-brand-primary hover:text-brand-primaryDark">
                                Edit
                              </button>
                            </div>
                          </div>
                    ...
                    <button className="w-full px-4 py-2 bg-brand-primary text-white rounded-md hover:bg-brand-primaryDark font-semibold">
                      Add New Role
                    </button>
                  </div>
                )
              }
              className="w-full mt-4 px-4 py-2 bg-brand-primary text-white rounded-md hover:bg-brand-primaryDark font-semibold transition-colors"
            >
              Manage Roles
            </button>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-3">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                          <p className="text-red-800 text-sm">
                            ⚠️ This action cannot be undone. Any applications
            ...
            <button
              ...
              className="w-full px-4 py-2 bg-brand-primary text-white rounded-md hover:bg-brand-primaryDark font-semibold transition-colors"
            >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-lg w-full p-6 relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-end space-x-3">
              ...
              {modalContent.title !== "New API Key Generated" &&
                modalContent.title !== "Revoke API Key" && (
                  <button className="px-4 py-2 bg-brand-primary text-white rounded-md hover:bg-brand-primaryDark font-semibold transition-colors">
                    Save Changes
                  </button>
                )}
            </div>
